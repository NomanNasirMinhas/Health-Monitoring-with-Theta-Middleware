...
declare type GetLatestInclusion = (transactions: ReadonlyArray<Hash>, callback?: Callback<ReadonlyArray<boolean>>) => Promise<ReadonlyArray<boolean>>;
export declare const addPersistence: (getLatestInclusion: GetLatestInclusion, bundles: readonly (readonly Transaction[])[]) => Promise<readonly (readonly Transaction[])[]>;
