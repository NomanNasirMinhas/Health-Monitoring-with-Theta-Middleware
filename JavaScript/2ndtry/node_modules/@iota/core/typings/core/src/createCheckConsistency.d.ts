 ...
 */
export declare const createCheckConsistency: ({ send }: Provider) => (transactions: string | readonly string[], options?: CheckConsistencyOptions | undefined, callback?: Callback<boolean> | undefined) => Promise<boolean>;
