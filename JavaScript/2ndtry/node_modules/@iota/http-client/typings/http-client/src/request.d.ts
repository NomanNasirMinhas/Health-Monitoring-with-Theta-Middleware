 ...
 * @reject {Error} - Request error
 */
export declare const batchedSend: <C extends BaseCommand>(requestParams: RequestParams<BatchableCommand<C>>, keysToBatch: ReadonlyArray<string>, requestBatchSize?: number) => Promise<any>;
export {};
