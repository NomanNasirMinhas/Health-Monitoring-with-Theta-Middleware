...
function PatientProfile() {
  ...
  useEffect(() => {
    ...
    async function getProfile() {
        ...
        console.log("Transaction=", resObj);
        if (resObj !== false) {
    ...
    <ThemeProvider theme={theme}>
      ...
      <Grid container spacing={2} style={{ marginTop: "2%" }}>
            ...
            >
              ...
              <div
                style={{
                  justifyContent: "center",
                  alignItems: "center",
                  display: "flex",  backgroundColor: "#2980B9",
                }}
              >
              ...
              <div className={classes.div} >
                <Typography variant="h6">
                  {" "}
                  <HomeIcon fontSize="small" style={{color:"black", }} /> {patient_address}
                </Typography> 
                </div>
                <div className={classes.div}> 
                  <Typography variant="h6">
                ...
                style={{
                  justifyContent: "center",
                  alignItems: "center",
                  display: "flex",  backgroundColor: "#2980B9", color:"white"
                }}
              >
              ...
              >
                <Typography variant="h6"> Admitted on : {admission_date}</Typography>
                </div>
        ...
        Doctor's Seed : <EllipsisText
              ...
              >
                <Typography variant="h5" style={{ marginTop: "2%",  }}>
        Patient's Address : <EllipsisText
                    text={Address}
                    length={"20"}/>
      </Typography>  
